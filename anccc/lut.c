...
rule_t rule_list[] = {
    ...
    R(argument_expression_list, argument_expression_list, assignment_expression),
    ...
    R(direct_declarator, PUNC1, type_qualifier_list, assignment_expression, PUNC2),
    R(direct_declarator, PUNC1, type_qualifier_list, PUNC2),
    R(direct_declarator, PUNC1, assignment_expression, PUNC2),
    R(direct_declarator, PUNC1, PUNC2),
    R(direct_declarator, PUNC1, K_STATIC, assignment_expression, PUNC2),
    R(direct_declarator, PUNC1, K_STATIC, type_qualifier_list, assignment_expression, PUNC2),
    R(direct_declarator, PUNC1, type_qualifier_list, K_STATIC, assignment_expression, PUNC2),
    R(direct_declarator, PUNC1, type_qualifier_list, PUNC12, PUNC2),
    R(direct_declarator, PUNC1, PUNC12, PUNC2),
